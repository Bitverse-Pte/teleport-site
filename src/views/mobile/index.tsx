...
import { MobileStyled } from "./style"
...
import roadmap from 'assets/imgs/mobile/roadmap.svg'
    ...
    return <MobileStyled>
            ...
            <div className="centerViewMobile   dflexRowBetweenCenter">
                ...
                <div className="rightNav">
                    <Dropdown className="dropdownView dflexRowCenterCenter" overlay={menu}
                        trigger={['click']}
                    >
                        <a className="ant-dropdown-link dropdownButton"
        ...
        <div className="bannerViewMobile">
            <div className="centerViewMobile ">
                <div className="title">Interoperability Platform
                </div>
                <div className="title title2">for Web3.0</div>
                <div className="subTitle">
                    Accelerate crypto assets &
                </div>
                <div className="subTitle subTitle2">dApps to multi-chain</div>
                <div>
                    {/* <span className="bannerBtn1 topMoveMobile">Docs</span> */}
                    <a className="bannerBtn1 topMoveMobile" target="_blank" href="https://docs.teleport.network">Docs</a>
                </div>
            </div>
        </div>
        ...
        <div className={["bridgeView",bridgeViewAnimate].join(" ")}>
            <div className="centerViewMobile dflexColumnStartCenter">
                ...
                <div className="sendToView dflexRowStartCenter">
                    ...
                    <div>
                        <img className="sendToArrowImg" src={sendToSvg} alt="" />
                    </div>
        ...
        <div className={["roadmapLineView dmb30", roadmapLineViewAnimate].join(" ")}>
            <div className="centerViewMobile">
                <div className="dflexRowCenterCenter">
                    <div className="">
                        <img className="roadmapImg" src={roadmap} alt="" />
                    </div>
            ...
            <div className="centerViewMobile ">
                <div className="dflexColumnStartCenter">
                    <div className="contactView dmb10">
                        <a className="contactItemMobile topMove" target="_blank" href="https://twitter.com/TeleportChain">
                        ...
                        <a className="contactItemMobile topMove" target="_blank" href="https://t.me/TeleportNetwork">
                        ...
                        <a className="contactItemMobile topMove" target="_blank" href="https://discord.gg/5YQtRDF4Rh">
                        ...
                        <a className="contactItemMobile topMove" target="_blank" href="https://medium.com/@TeleportNetwork">
                            <svg viewBox="0 0 38 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a className="contactItemMobile topMove" title="support@teleport.network" href="mailto:support@teleport.network">
                ...
                <div className="text">©2022 Teleport Network. All rights reserved.</div>
            </div>
        </div>
    </MobileStyled>
}
